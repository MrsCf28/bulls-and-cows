...
class Address implements Comparable<Address> {
    ...
    public int compareTo(Address otherAddress) {
        if (house.compareTo(otherAddress.house) > 0) {
            return 1;
        } else if (house.compareTo(otherAddress.house) < 0) {
            return -1;
        } else if (street.compareTo(otherAddress.street) > 0) {
            return 1;
        } else if (street.compareTo(otherAddress.street) < 0) {
            return -1;
        } else if (city.compareTo(otherAddress.city) < 0) {
            return -1;
        } else if (city.compareTo(otherAddress.city) > 0) {
            return 1;
        } else {
